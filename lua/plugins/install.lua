...
install({ "windwp/nvim-ts-autotag", "neovim/nvim-lspconfig", "ibhagwan/fzf-lua",
  ...
  "3rd/image.nvim", "windwp/nvim-autopairs", "lervag/vimtex", "stevearc/conform.nvim", "rmagatti/auto-session",
  "nvim-lua/plenary.nvim", { src = "ThePrimeagen/harpoon", version = "harpoon2" }, "sainnhe/gruvbox-material",
  "mfussenegger/nvim-jdtls", "aserowy/tmux.nvim" })
end_bench()
